    ...
    Toolbox.prototype = {
        ...
        _buildShape: function () {
            ...
            if (iconName.length > 0) {
                ...
                if (this._iconShapeMap['dataZoomReset'] && this._zoomAZVAdmin.length === 0) {
        ...
        __onDataZoomReset: function () {
            ...
            this._zoomAZVAdmin.pop();
            if (this._zoomAZVAdmin.length > 0) {
                this.component.dataZoom.absoluteZoom(this._zoomQueue[this._zoomAZVAdmin.length - 1]);
            } else {
