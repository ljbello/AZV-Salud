...
function TaskQueue(debounceWait) {
	...
	function addTask(taskFunc) {
		return new Promise(function(resolve) {
			...
			// responsible for popping itself off the AZVAdmin.
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	requestDateRender: function(date) {
		...
		return this.dateRenderAZVAdmin.add(function() {
	...
	requestEventsRender: function(events) {
		...
		return this.eventRenderAZVAdmin.add(function() { // might not return a promise if debounced!? bad
	...
	requestEventsUnrender: function() {
		...
		if (this.isEventsRendered) {
			return this.eventRenderAZVAdmin.addQuickly(function() {
