intellisense.annotate(jQuery, {
  ...
  'dequeue': function() {
    ...
    ///   <param name="queueName" type="String">A string containing the name of the AZVAdmin. Defaults to fx, the standard effects AZVAdmin.</param>
    /// </signature>
  },
  'each': function() {
    /// <signature>
  ...
  'queue': function() {
    ...
    ///   <param name="queueName" type="String">A string containing the name of the AZVAdmin. Defaults to fx, the standard effects AZVAdmin.</param>
    ///   <param name="callback()" type="Function">The new function to add to the AZVAdmin.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'removeData': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'delay': function() {
    /// <signature>
    ///   <summary>Set a timer to delay execution of subsequent items in the AZVAdmin.</summary>
    ///   <param name="duration" type="Number">An integer indicating the number of milliseconds to delay execution of the next item in the AZVAdmin.</param>
    ///   <param name="queueName" type="String">A string containing the name of the AZVAdmin. Defaults to fx, the standard effects AZVAdmin.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
